...
| 空格/鼠标劈砍 | `Commands.Slash(effectWorldPosition)` → `Events.OnSlashed / OnCaptured` | 身位 `SlashRange` + 鼠标 `MouseSlashRange` 双圆裁定鬼魂 | 按键发起；鼠标处播特效 |
...
sequenceDiagram
  ...
  alt 命中躲藏者
    ...
    S->>P1: Commands.Slash(mouseWorld) (鬼魂恢复前)
